    ...
    return {
      ...
      tech: [
        ...
        },
        {
          ...
          name: "Codeigniter",
          imageUrl:
            "https://toppng.com/free-image/code-igniter-logo-PNG-free-PNG-Images_472578",
          status: "Advance",
        },
        {
          id: 7,
        ...
        },
        {
          ...
          name: "Python",
          imageUrl:
            "https://cdn4.iconfinder.com/data/icons/logos-3/600/python_logo-512.png",
          status: "Advance",
        },
        {
          id: 14,
          name: "AI",
          imageUrl:
            "https://cdn4.iconfinder.com/data/icons/logos-3/600/ai_logo-512.png",
          status: "Advance",
        },
        {
          id: 15,
          name: "Ruby",
          imageUrl:
            "https://cdn4.iconfinder.com/data/icons/logos-3/600/ruby_logo-512.png",
          status: "Advance",
        },
        {
          id: 16,
          name: "C++",
          imageUrl:
            "https://cdn4.iconfinder.com/data/icons/logos-3/600/c-512.png",
          status: "Advance",
        },
        {
          id: 17,
        ...
        },
        {
          ...
          name: ".NET",
          imageUrl:
            "https://cdn4.iconfinder.com/data/icons/logos-3/600/net-512.png",
          status: "Advance",
        },
        {
          id: 19,
          name: "Angular",
          imageUrl:
            "https://cdn4.iconfinder.com/data/icons/logos-3/600/angular-512.png",
          status: "Advance",
        },
        {
          id: 20,
          name: "Mobile",
          imageUrl:
            "https://cdn4.iconfinder.com/data/icons/logos-3/600/mobile-512.png",
          status: "intermediate",
        },
      ],
      tools: [
      ...
      >
        ...
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hello everyone! My name is Akira Uchiyama. I am
            a Full-Stack and AI/ML Engineer with 10+ years of experience
            designing and building scalable, cloud-native software solutions, as
            well as developing state-of-the-art LLM, Generative AI, and NLP
            systems.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; I have a proven track record of collaborating
            with cross-functional teams to deliver production-grade
            applications, including microservices architectures, CI/CD
            pipelines, and real-time data platforms using technologies such as
            Django, React, Kubernetes, and Terraform.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; My expertise includes integrating RAG
            architectures, LangChain, Hugging Face, GPT-3.5/4, and reinforcement
            learning techniques to optimize system performance, reduce
            operational costs, and enhance end-user experiences.
          </p>
          <p class="mb-3 fadein-left fadeins-2">
            &nbsp; &nbsp; &nbsp; I am passionate about building end-to-end AI
            platforms that combine modern web technologies, deep learning, and
            robust DevOps practices to create impactful solutions for both
